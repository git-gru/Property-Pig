        ...
        if(!empty($_SESSION['qn']))
        {
           ...
           foreach ($_SESSION['qn'] as $value) 
           {
            ...
            if ($secret == "pig990") 
            {
                ...
                //die("select * from pig_user_answer where user_id='".$id."' and property_id='".$propertyId."'");
                $query  = $dbh->prepare("select * from pig_user_answer where user_id=:id and property_id=:propertyId");
