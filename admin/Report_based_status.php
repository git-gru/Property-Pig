                ...
                <div class="ndiv tab active tab-sec-one">
                   <div id="example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="col-md-12" style="margin-right: 25px;float: right;">
                            <div class="col-md-2" style="margin: 20px 0px;float: right;">
                                <select class="form-control" id="status_controler" onchange="return get_result();">
                                    <option value="new">New</option> 
                                    <option value="passed_to_exit_strategy">Passed to Exit Strategy</option>
...
$query1->bindParam(":property_id",$row['property_id']);
        ...
        <script>
                         ...
                         $.ajax({
                                ...
                                success: function (result) {
                                   ...
                                   if(result==1)
                                   {
                                       ...
                                       setTimeout(function () {  window.location.href = "pending_request.php";}, 2000);
                                   }
                                   else
                                   {
                                       alert("Error Found!!!");
            ...
            function get_result()
            {
                        $.ajax({
                                type: "POST",
                                data: "status=" + $('#status_controler').val(),
                                url: "status_controler.php",
                                success: function (result) {
                                   console.log(result)
